...
<form name="contactForm" action="https://formspree.io/rebecca@oaktreehomebuyers.com" method="POST">
<input type="hidden" name="_next" value="http://oaktreehomebuyers.com/">
